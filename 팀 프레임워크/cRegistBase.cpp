...
void cRegistBase::SoundRegist()
{
	...
	FILEPATH_MANAGER->AddFilepath("불꽃", "Resource/Sound/불꽃1.mp3");
	FILEPATH_MANAGER->AddFilepath("힐링", "Resource/Sound/힐링1.mp3");

	FILEPATH_MANAGER->AddFilepath("하늘의대검", "Resource/Sound/하늘의 대검_폭파.mp3");

	FILEPATH_MANAGER->AddFilepath("쉴드1", "Resource/Sound/쉴드.ogg");
	FILEPATH_MANAGER->AddFilepath("쉴드2", "Resource/Sound/쉴드2.ogg");
	FILEPATH_MANAGER->AddFilepath("매직슈터", "Resource/Sound/매직슈터.mp3"); 
	
	FILEPATH_MANAGER->AddFilepath("번개", "Resource/Sound/번개이펙트소리.wav");
	FILEPATH_MANAGER->AddFilepath("별빛", "Resource/Sound/별빛이펙트소리.wav");
