...
cUserInterfaceTest::cUserInterfaceTest()
{
}
...
HRESULT cUserInterfaceTest::init()
{
	//============================================================================================
	// 플레이어 바
	//============================================================================================
...
void cUserInterfaceTest::release()
{
...
void cUserInterfaceTest::update()
{
...
void cUserInterfaceTest::render()
{
	m_pPlBar->render();
	m_pBar->render();
	m_pBar2->render();
...
void cUserInterfaceTest::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
