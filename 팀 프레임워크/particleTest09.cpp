...
HRESULT particleTest09::init(void)
{
	...
	//_testEmitter->init("PaticleResources/Mesh/stone.x", 20, 0.1f, 100);
	_testEmitter->init("Resource/Meshes/Elementalist/Elementalist.x", 20, 0.1f, 100);
...
void particleTest09::release(void)
{
	SAFE_DELETE(_testPS);
}

void particleTest09::update(void)
{
...
void particleTest09::render(void)
{
	//_testSkill->render();
