...
HRESULT stageFour::init()
{
	...
	_terrain->setTile0(IOMAPMANAGER->loadMapInfo("성밖지형").tile0, true);
	_terrain->setTile1(IOMAPMANAGER->loadMapInfo("성밖지형").tile1, true);
	_terrain->setTile2(IOMAPMANAGER->loadMapInfo("성밖지형").tile2, true);
	_terrain->setTile3(IOMAPMANAGER->loadMapInfo("성밖지형").tile3, true);
	_terrain->setSplat(IOMAPMANAGER->loadMapInfo("성밖지형").splat, true);
	...
	_terrainShadow->setTile0(IOMAPMANAGER->loadMapInfo("성밖지형").tile0, true);
	_terrainShadow->setTile1(IOMAPMANAGER->loadMapInfo("성밖지형").tile1, true);
	_terrainShadow->setTile2(IOMAPMANAGER->loadMapInfo("성밖지형").tile2, true);
	_terrainShadow->setTile3(IOMAPMANAGER->loadMapInfo("성밖지형").tile3, true);
	_terrainShadow->setSplat(IOMAPMANAGER->loadMapInfo("성밖지형").splat, true);
	_terrainShadow->setMapPosition(IOMAPMANAGER->loadMapInfo("성밖지형").vecPos);
