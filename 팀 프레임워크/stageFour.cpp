...
HRESULT stageFour::init()
{
	...
	_terrain->setSplat(IOMAPMANAGER->loadMapInfo("성밖지형").splat);
	...
	_terrainShadow->setTile0(IOMAPMANAGER->loadMapInfo("성밖지형").tile0);
	_terrainShadow->setTile1(IOMAPMANAGER->loadMapInfo("성밖지형").tile1);
	_terrainShadow->setTile2(IOMAPMANAGER->loadMapInfo("성밖지형").tile2);
	_terrainShadow->setTile3(IOMAPMANAGER->loadMapInfo("성밖지형").tile3);
	_terrainShadow->setSplat(IOMAPMANAGER->loadMapInfo("성밖지형").splat);
