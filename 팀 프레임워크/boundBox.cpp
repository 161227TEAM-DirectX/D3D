...
void boundBox::renderGizmo(dx::transform * trans)
{
	...
	GIZMOMANAGER->Line(worldPos[0], worldPos[4], 0xff00ff00);
	GIZMOMANAGER->Line(worldPos[1], worldPos[5], 0xff00ff00);
	GIZMOMANAGER->Line(worldPos[2], worldPos[6], 0xff00ff00);
	GIZMOMANAGER->Line(worldPos[3], worldPos[7], 0xff00ff00);
