#include "stdafx.h"
#include "dxCylinderEmitter.h"

HRESULT dxCylinderEmitter::init(string textureFileName, int OneTimePaticleNum, float spawnTime, int totalPaticleNum)
{
...
void dxCylinderEmitter::ActiveUpdatePlane(tagDxParticleEX * ptcVertex, DWORD * ptcIndex, vector<tagDxAttribute>::iterator iter, DWORD drawParticleNum)
{
	//파티클 위치 값
