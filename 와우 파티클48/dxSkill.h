...
public:
	virtual void setPlayer(transform* inPlayerTrans) { _playerTrans = inPlayerTrans; };
	virtual void setTarget(transform* inTargetTrans) { _targetTrans = inTargetTrans; };
