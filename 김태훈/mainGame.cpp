...
HRESULT mainGame::init(void)
{
	...
	//씬추가
	SCENEMANAGER->addScene("쉐도우1", new shadowTest1);
	SCENEMANAGER->addScene("쉐도우2", new shadowTest2);
	SCENEMANAGER->addScene("플레이어테스트", new testScene1);
	//씬초기화
	SCENEMANAGER->changeScene("플레이어테스트");
