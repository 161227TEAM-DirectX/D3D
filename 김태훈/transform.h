...
public:
	...
	//축을 바꿔라.
	void setAxis(D3DXVECTOR3 right, D3DXVECTOR3 up, D3DXVECTOR3 forward) { this->right = right, this->up = up, this->forward = forward; }
	...
	//스케일값 얻기
	D3DXVECTOR3 GetScale() { return this->scale; }
	...
	void ShakeUpdate(float _timeDelta);
