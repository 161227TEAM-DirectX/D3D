...
HRESULT shaderHW1::init(void)
{
	...
	D3DXCreateEffectFromFile(
		_device,			//디바이스
		"Texture_Gray.fx",	//불러올 셰이더 코드 파일이름
